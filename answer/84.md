### 해답
```
解答1(야마다) $ zcat newline.txt.gz | tr -dc '\015\012' | sed -z 's/\x0d/CR/g;s/\x0a/LF&/g' | sort | uniq -c | awk '{print $2,$1}'
...
```
다른 풀이 1 $ zcat newline.txt.gz | awk '/\r$/ {r++} END {print "LF", NR - r; print "CRLF", r}'
```
